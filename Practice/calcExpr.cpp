...
string inputAndInterpretation() {
	...
	try 
	{
		...
		if(quanOpenBr != quanCloseBr) exceptions.push_back("\nERROR: íåñîâïàäåíèå êðóãëûõ îòêðûâàþùèõ è çàêðûâàþùèõ ñêîáîê");
		if(quanSquareOpenBr != quanSquareCloseBr) exceptions.push_back("\nERROR: íåñîâïàäåíèå êâàäðàòíûõ îòêðûâàþùèõ è çàêðûâàþùèõ ñêîáîê");
		if(quanBrMod % 2 != 0) exceptions.push_back("\nERROR: íåñîâïàäåíèå îòêðûâàþùèõ è çàêðûâàþùèõ ñêîáîê ìîäóëÿ");
...
int main() {
	...
	cout << "\nÄîñòóïíûå ôóíêöèè\n-----------------\n";
	cout << "ln(x) - âîçâðàùàåò íàòóðàëüíûé ëîãàðèôì ÷èñëà õ\n";
	cout << "lg(x) - âîçâðàùàåò äåñÿòè÷íûé ëîãàðèôì ÷èñëà õ\n";
	cout << "log(x, y) - âîçâðàùàåò ëîãàðèôì ÷èñëà Õ ñ îñíîâàíèåì Ó\n";
	cout << "tg(x) - âîçâðàùàåò òàíãåíñ õ, ïðåäñòàâëåííîãî â ãðàäóñàõ\n";
	cout << "ctg(x) - âîçâðàùàåò êîòàíãåíñ õ, ïðåäñòàâëåííîãî â ãðàäóñàõ\n";
	cout << "sin(x) - âîçâðàùàåò ñèíóñ õ, ïðåäñòàâëåííîãî â ãðàäóñàõ\n";
	cout << "cos(x) - âîçâðàùàåò êîñèíóñ õ, ïðåäñòàâëåííîãî â ãðàäóñàõ\n";
	cout << "sqrt(x) - âîçâðàùàåò êâàäðàòíûé êîðåíü èç ÷èñëà õ\n";
	cout << "sqrt(x, n) - âîçâðàùàåò êîðåíü èç ÷èñëà õ ñ ïîêàçàòåëåì n\n";
	cout << "arcsin(x) - âîçâðàùàåò àðêñèíóñ ÷èñëà õ\n";
	cout << "arccos(x) - âîçâðàùàåò àðêêîñèíóñ ÷èñëà õ\n";
	cout << "arctg(x) - âîçâðàùàåò àðêòàíãåíñ ÷èñëà õ\n";
	cout << "arcctg(x) - âîçâðàùàåò àðêêîòàíãåíñ ÷èñëà õ\n";
	cout << "x ^ y - âîçâîäèò õ â ñòåïåíü ó\n";
	cout << "|x| - âîçâðàùàåò ìîäóëü ÷èñëà õ\n";
	SetColorText(green, "\nÄëÿ âûõîäà íàæìèòå CTRL+C,\näëÿ âû÷èñëåíèÿ - ENTER\n", white);
